	...
	<div class="main">
		<table class="table sheet">
			...
			<tr>
				...
				<td>
					<a onClick="jump('{url channel=$global.channel mod='link_edit' id=$item.id}')">[修改]</a>
					<a onClick="del('link|{$item.id}')">[删除]</a>
				</td>
			</tr>
			{/foreach}
			<tr>
				<td colspan="8">
					<div class="bt_row">
						<input class="button" type="button" onClick="jump('{url channel=$global.channel mod='link_add'}')" value="添加" />
					</div>
				</td>
			</tr>
		</table>
