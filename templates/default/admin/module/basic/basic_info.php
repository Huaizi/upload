...
<!-- <div class="block">
	...
	<div class="main">
		<table class="table">
			<tr>
				<td><a href="{url channel='site' mod='admin_list'}">修改密码</a></td>
				<td><a href="{url channel='site' mod='nav_list'}">导航管理</a></td>
				<td><a href="{url channel='goods' mod='cat_list'}">商品分类</a></td>
